...
public class ParametersforAlgorithm extends DefaultParameters {
    ...
    public int getMaxEvaluations() {
        return maxIteractions * populationSize;
    }
     ...
     *
     * @param neighborhoodSelectionProbability the neighborhood selection
     * probability
     */
     ...
     *
     * @param maximumNumberOfReplacedSolutions the maximum number of replaced
     * solutions
     */
    ...
    public String toString() {
        return "ParametersforAlgorithm{" + "populationSize=" + populationSize + ", archiveSize=" + archiveSize + ", maxIteractions=" + maxIteractions + ", algorithmName=" + algorithmName + ", weightsPath=" + weightsPath + ", neighborSize=" + neighborSize + ", neighborhoodSelectionProbability=" + neighborhoodSelectionProbability + ", maximumNumberOfReplacedSolutions=" + maximumNumberOfReplacedSolutions + ", moeadFunction=" + moeadFunction + ", smsOffset=" + smsOffset + '}';
    }
}
