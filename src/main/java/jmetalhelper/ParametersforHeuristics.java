...
public class ParametersforHeuristics extends DefaultParameters {
  ...
  public String toString() {
    return "ParametersforHeuristics{" + "deCr=" + deCr + ", deF=" + deF + ", deK=" + deK + ", crossoverProbality=" + crossoverProbality + ", alpha=" + alpha + ", deVariant=" + deVariant + ", crossoverName=" + crossoverName + ", crossoverDistribution=" + crossoverDistribution + ", mutationName=" + mutationName + ", mutationProbability=" + mutationProbability + ", mutationPertubation=" + mutationPertubation + ", mutationDistribution=" + mutationDistribution + ", numberOfVariables=" + numberOfVariables + '}';
  }
