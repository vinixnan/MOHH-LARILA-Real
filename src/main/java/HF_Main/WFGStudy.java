 ...
 */
public class WFGStudy<S extends Solution<?>> {
    ...
    public static void main(String[] args) throws IOException, JMException {
        ...
        problemList.add(new ExperimentProblem<>(new WFG1(k, l, m)).changeReferenceFrontTo("WFG1."+m+"D.pf"));
        
        problemList.add(new ExperimentProblem<>(new WFG2(k, l, m)).changeReferenceFrontTo("WFG2."+m+"D.pf"));
        problemList.add(new ExperimentProblem<>(new WFG3(k, l, m)).changeReferenceFrontTo("WFG3."+m+"D.pf"));
        
        problemList.add(new ExperimentProblem<>(new WFG4(k, l, m)).changeReferenceFrontTo("WFG4."+m+"D.pf"));
        problemList.add(new ExperimentProblem<>(new WFG5(k, l, m)).changeReferenceFrontTo("WFG5."+m+"D.pf"));
        
        problemList.add(new ExperimentProblem<>(new WFG6(k, l, m)).changeReferenceFrontTo("WFG6."+m+"D.pf"));
        
        problemList.add(new ExperimentProblem<>(new WFG7(k, l, m)).changeReferenceFrontTo("WFG7."+m+"D.pf"));
        
        problemList.add(new ExperimentProblem<>(new WFG8(k, l, m)).changeReferenceFrontTo("WFG8."+m+"D.pf"));
        problemList.add(new ExperimentProblem<>(new WFG9(k, l, m)).changeReferenceFrontTo("WFG9."+m+"D.pf"));
        ...
        Experiment<DoubleSolution, List<DoubleSolution>> experiment
                = new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("WFGCompleteStudy3obj")
